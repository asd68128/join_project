...
public class Deluser implements Serializable {
    ...
    public Deluser(int userId, String userName, String userPwd, String userSex, Date userCreateDate, String userPhoto, String userLike, int userType, String userReallyName, String userPhone) {
        this.userId = userId;
